...
# Pipeline
pl1 = Pipeline(steps=[
    ("1", FunctionTransformer(categorize, validate=False,
                              kw_args={"category_columns": category_columns})),
    ("2", FunctionTransformer(drop_useless_cols,
                              validate=False, kw_args={"useless_cols": useless_cols})),
    ("3", FunctionTransformer(age_imputer, validate=False)),
    ("4", FunctionTransformer(log_transform,
                              validate=False, kw_args={"col_to_transform": "Fare"}))
])
